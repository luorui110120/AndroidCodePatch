package com.coderstory.sslkiller;
...
public class SSLKiller  implements IXposedHookLoadPackage{
    ...
    public static TrustManager[] trustManagers = new TrustManager[] {new TrustAllX509TrustManager()};

    public static XC_MethodHook getSocketFactoryHook = new XC_MethodHook() {
        @Override
    ...
    public static XC_MethodHook sslContextInitHook = new XC_MethodHook() {
        @Override
        protected void beforeHookedMethod(MethodHookParam param) throws Throwable
        {
    ...
    public static XC_MethodHook hostNameVerifierHook = new XC_MethodHook() {
        @Override
        protected void beforeHookedMethod(MethodHookParam param) throws Throwable
        {
    ...
    public static XC_MethodHook setSSLSocketFactoryHook = new XC_MethodHook() {
        @Override
        protected void beforeHookedMethod(MethodHookParam param) throws Throwable
        {
    ...
    public static XC_MethodHook urlConnectionHook = new XC_MethodHook() {
